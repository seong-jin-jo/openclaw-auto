...
**역할 (2026-07-07 재정의):** 시장·리테션·위키도구 등 **원자료 데이터만** 보관한다. 결론·전략은 [marketing/](../5-hubs/hub-mkt/_index.md)이 정본 — 경쟁사 표 = [marketing/competitors.md](../2-product/insight/competitors.md), 포지셔닝 = [marketing/positioning.md](../1-team-brand/market-positioning.md), 마케팅 실무 = [marketing/playbook.md](../5-hubs/hub-mkt/playbook.md).
...
- 함의: 하이브리드(기본 구독 ₩100–200k + 사용량)로 mid-tier NRR 확보 — [decisions/003](../3-operations/decisions/003-moat-and-pricing-strategy.md) 근거 데이터.
...
- 경쟁 표 갱신은 [marketing/competitors.md](../2-product/insight/competitors.md)에 (분기), 원자료·시장 데이터는 여기에.
- 소스: opus.pro/pricing, pictory.ai/pricing, ChartMogul/Optifai 2026 리텐션 리포트, Grand View/Fortune/Dataintelo 시장 데이터, Trustpilot/ProductHunt/Reddit/X, gstack repo. 2026-07 추가분: [marketing/proposals/2026-07-07-benchmark-refresh.md](../5-hubs/hub-mkt/proposals/2026-07-07-benchmark-refresh.md).
