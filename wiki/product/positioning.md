...
- **판정 근거**: 이 확정으로 위 4층 판정의 4층(AARRR 퍼널)은 "비전 섹션 전용"에서 **"기본 제품 범위 밖, 웹 고객 옵션"으로 한 칸 더 내려간다.** GA4·슬랙 중앙 성과 통합(`wiki/product/plan-ga4-slack-central.md`)은 후순위 옵션 트랙으로 재분류한다.
