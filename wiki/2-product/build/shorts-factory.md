...
- 서비스 경계는 [two-service-boundary.md](../../5-hubs/hub-eng/architecture/two-service-boundary.md)를 따른다. 아래 6월 Current State와 gstack 문구는 이력이며 현행 구현 총계·절차가 아니다.
...
- wiki/5-hubs/hub-eng/architecture/overview.md
