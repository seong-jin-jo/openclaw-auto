...
작성: content-growth-marketer (서브에이전트) / 대상: wiki/4-reference/benchmarking.md + wiki/2-product/build/vision.md "Competitive Benchmarking" 절 갱신용
...
## 4. 위키 시스템 개선 제안 — `wiki/5-hubs/hub-mkt/` 신설
