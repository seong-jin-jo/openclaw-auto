...
2026-08-28 현재 시스템 구조의 고수준 요약이다. 구성 요소 존재와 운영 검증은 다르며, 최신 단계·QA 경계는 [현재 제품·검증 상태](../../../2-product/build/current-state.md)를 따른다.
...
- YouTube·TikTok 영상 발행 경로는 코드에 존재한다. 최신 실채널 발행과 운영 배포는 미검증이다.
...
[Marketing Hub surface map](../../../2-product/build/marketing-hub-surface-map.md) for route-level classification.
...
ADR: `wiki/3-operations/decisions/004-social-connect-oauth-not-passwords.md`
