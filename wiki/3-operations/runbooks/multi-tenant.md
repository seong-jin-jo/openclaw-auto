...
**상세 전체 (터널, GHA, 빌드 규칙, 버그, 스모크, 교훈)**: `wiki/4-reference/learnings/2026-06-19-openclaw-osmu-handoff.md` **반드시 먼저 읽을 것**.
...
- 상세 운영 컨텍스트: `wiki/4-reference/learnings/2026-06-19-openclaw-osmu-handoff.md` 참조.
...
**⚠️ 필수 선행**: `wiki/4-reference/learnings/2026-06-19-openclaw-osmu-handoff.md` 전체 읽기.
...
자세한 Cloudflare 설정은 별도 `wiki/3-operations/runbooks/deploy.md`에 문서화 예정.
- Cron: tenant-aware execution + rate limit.

자세한 Cloudflare 설정과 코드는 `wiki/3-operations/runbooks/deploy.md` (추가 예정)와 architecture 문서 참조.
