...
4. **Generate plan**
   ...
   ```
   Produces a concrete, reviewed execution plan. Save it (often to wiki/3-operations/decisions/ or plans/).
...
8. **Capture & Document**
   ...
   - Add to wiki/4-reference/learnings/ or wiki/ as appropriate.
...
- Shorts factory enhancements: Always start from wiki/2-product/build/ + longform-to-shorts + video-generate docs.
