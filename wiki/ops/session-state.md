...
- 커밋: `6c8bda1f`, `f70be33d`, `526524bb`, `108d5159`, `9d5809c2`, `46c806ef`, `96e0be2d`. 최종 문서 커밋과 원격 push는 이어서 수행한다.
- 배포: 머지와 운영 배포는 하지 않았다. 다음 QA는 브랜치 CI 통과를 확인한 뒤 운영 후보 환경에서 실제 외부 생성 응답과 카드뉴스 사진 후보 범위를 검증한다.
