...
DECLARE t text;
BEGIN
  FOREACH t IN ARRAY ARRAY['brand_guides','integrations','drafts','published_posts','schedules','growth_metrics','viral_signals','wiki_docs','usage_events','subscriptions','usage_quotas'] LOOP
