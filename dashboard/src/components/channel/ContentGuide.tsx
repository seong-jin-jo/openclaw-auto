    ...
    <div className="card p-5">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-medium text-muted">
          Content Guide <span className="text-[10px] text-subtle">({label})</span>
        </h3>
      ...
      {suggestion && (
        <div className="mt-3 border border-accent rounded-lg bg-accent-soft p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-accent font-medium">AI 제안</span>
            <div className="flex gap-2">
              <button onClick={handleApplySuggestion} className="px-2 py-1 text-[10px] bg-accent text-text rounded hover:bg-accent-hover">
                적용하기
              </button>
              <button
              ...
              <button onClick={() => setSuggestion(null)} className="px-2 py-1 text-[10px] text-subtle hover:text-muted">
                닫기
              </button>
            </div>
          </div>
