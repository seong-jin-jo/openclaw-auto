  ...
  return (
    <aside className="w-56 border-r border-gray-800/50 flex flex-col h-screen sticky top-0" style={{ background: "#0e0e0e" }}>
      ...
      <nav className="flex-1 py-3">
        ...
        <Link
          href="/performance"
          className={`sidebar-item ${pathname === "/performance" ? "active" : ""} w-full text-left px-4 py-2 text-sm flex items-center gap-3 ${pathname === "/performance" ? "text-white" : "text-gray-200"}`}
        >
