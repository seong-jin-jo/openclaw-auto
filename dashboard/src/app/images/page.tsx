    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {images.length === 0 ? (
        <div className="card p-12 text-center">
          <svg className="w-12 h-12 text-subtle mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <p className="text-subtle">아직 생성된 이미지가 없습니다</p>
          <p className="text-xs text-subtle mt-1">image_generate tool로 이미지를 생성하면 여기에 표시됩니다</p>
        </div>
      ) : (
            ...
            <div key={img.filename} className="card overflow-hidden group relative">
              ...
              <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                <button
                  ...
                  className="p-1.5 bg-surface/80 rounded text-muted hover:text-text"
                  title="URL 복사"
                >
                ...
                <button
                  ...
                  className="p-1.5 bg-surface/80 rounded text-red-400 hover:text-red-300"
                  title="삭제"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
