    ...
    <div className="px-8 py-6">
      ...
      <div className="card p-6 text-center">
        ...
        <a
          ...
          className="inline-block px-4 py-2 text-sm bg-accent text-text rounded hover:bg-accent-hover"
        >
          Google Trends 열기
        </a>
      </div>
      ...
      <div className="card p-4 mt-6">
        <h3 className="text-sm font-medium text-muted mb-3">활용 가이드</h3>
        <ul className="text-xs text-subtle space-y-2">
