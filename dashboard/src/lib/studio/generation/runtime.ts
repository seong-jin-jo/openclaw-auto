...
const studioGlobal = globalThis as typeof globalThis & {
  __studioGenerationRuntime?: { version: 2; service: GenerationService };
};

function runtimeInstance(): GenerationService {
  if (studioGlobal.__studioGenerationRuntime?.version !== 2) {
...
export function setGenerationRuntimeForTests(service: GenerationService): void {
  studioGlobal.__studioGenerationRuntime = { version: 2, service };
}
