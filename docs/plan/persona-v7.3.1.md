# OSMU Marketing Agent — Persona v7.3.1
...
evidence: PRD v7.3.1, critic v7.3.0, user failure reports, current Studio/brand code, audit96
...
|---|---|
| 버전 | v7.3.1 |
| 정본 | [PRD v7.3.1](openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md) |
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md`; critic v7.3.0; audit96; agency blueprint14; user-reported OAuth/Studio/OSMU failures; current Studio/RepoConnect/BrandSetupWizard.
MODEL: gpt-codex/gpt-5.6-sol
