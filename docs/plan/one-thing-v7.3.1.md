# OSMU Marketing Agent — One Thing v7.3.1
...
evidence: PRD v7.3.1, critic v7.3.0, audit96/P0-8, Jasper/HubSpot official workflows
...
|---|---|---|---|
| Ground | source5 | active knowledge1+guide1+fact/source/tone/taboo/proof snapshot | dual truth/unknown approval0 |
...
- Source5는 ingestion adapter와 provenance만 다르고 active knowledge1+active guide1의 exclusive truth로 수렴한다.
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md`; `tasks/marketing-agent-plan-critic-v7.3.0.output`; final audit96; agency blueprint14; Jasper Brand Voice/Knowledge Base; HubSpot Campaigns; Buffer/Sprout official workflows.
MODEL: gpt-codex/gpt-5.6-sol
