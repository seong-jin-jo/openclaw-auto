# OSMU Marketing Agent — One Thing v7.3.3
...
evidence: PRD v7.3.3, critic v7.3.2, updated audit96 v1.2/P0-8, Audit96 source-predicate manifest, Jasper/HubSpot official workflows
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.3-gpt-codex.md`; `tasks/marketing-agent-plan-critic-v7.3.2.output`; updated final audit96 v1.2; Audit96 source-predicate manifest; agency blueprint14; Notion export; Medium/Substack publishing help; Jasper Brand Voice/Knowledge Base; HubSpot Campaigns.
MODEL: gpt-codex/gpt-5.6-sol
