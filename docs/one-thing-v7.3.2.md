# OSMU Marketing Agent — One Thing v7.3.2
...
evidence: PRD v7.3.2, critic v7.3.1, audit96/P0-8, Jasper/HubSpot official workflows
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.2-gpt-codex.md`; `tasks/marketing-agent-plan-critic-v7.3.1.output`; final audit96; agency blueprint14; Notion export; Medium/ Substack publishing help; Jasper Brand Voice/Knowledge Base; HubSpot Campaigns.
MODEL: gpt-codex/gpt-5.6-sol
