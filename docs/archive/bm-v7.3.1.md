# OSMU Marketing Agent — BM v7.3.1

<!-- STAMP | created_at: 2026-08-07 13:13 KST | model: gpt-codex/gpt-5.6-sol | agent: prd-architect | skills: brand-positioning-kit, openclaw-creative-brief | evidence: PRD v7.3.1, critic v7.3.0, audit96, HubSpot/Jasper/Buffer | deliberation: 이중 진실과 thin-data 자동변경을 막는 신뢰 운영까지 캠페인 가치에 포함한다. -->
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md`; critic v7.3.0; audit96; HubSpot Campaigns; Jasper IQ/Brand Voice; Buffer Agency; Sprout Approval.
