# OSMU Marketing Agent — BM v7.3.3

<!-- STAMP | created_at: 2026-08-07 16:20 KST | model: gpt-codex/gpt-5.6-sol | agent: prd-architect | skills: brand-positioning-kit, openclaw-creative-brief | evidence: PRD v7.3.3, critic v7.3.2, updated audit96 v1.2, HubSpot/Jasper/Buffer | deliberation: 의미가 어긋난 계약과 자격증명 종류별 경계를 고쳐 신뢰 운영까지 캠페인 가치에 포함한다. -->
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.3-gpt-codex.md`; critic v7.3.2; updated audit96 v1.2; HubSpot Campaigns; Jasper IQ/Brand Voice; Buffer Agency; Sprout Approval.
