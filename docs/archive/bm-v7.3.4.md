# OSMU Marketing Agent — BM v7.3.4

<!-- STAMP | created_at: 2026-08-07 17:05 KST | model: gpt-codex/gpt-5.6-sol | agent: prd-architect | skills: brand-positioning-kit, openclaw-creative-brief | evidence: PRD v7.3.4, critic v7.3.3, updated audit96 v1.2+H/E/F288, HubSpot/Jasper/Buffer | deliberation: 기존 기능을 넓히기보다 96개 고객 운영 계약을 실제 관찰 가능한 happy/edge/failure로 닫는다. -->
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.4-gpt-codex.md`; critic v7.3.3; updated audit96 v1.2+H/E/F288; HubSpot Campaigns; Jasper IQ/Brand Voice; Buffer Agency; Sprout Approval.
