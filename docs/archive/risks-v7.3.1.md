# OSMU Marketing Agent — Risks v7.3.1

<!-- STAMP | created_at: 2026-08-07 13:13 KST | model: gpt-codex/gpt-5.6-sol | agent: prd-architect | skills: brand-positioning-kit, openclaw-creative-brief | evidence: PRD v7.3.1, critic v7.3.0, audit96, current brand/Studio/analytics | deliberation: 이중 truth와 thin-data eligibility를 named kill gate로 승격한다. -->

| 항목 | 값 |
|---|---|
| 버전·정본 | v7.3.1 · [PRD v7.3.1](openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md) |
...
| dual knowledge truth | `wiki_docs`/`brand_guides`가 서로 다른 active 값 제공 | active knowledge1+guide1, legacy direct read0, KCONV20 |
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.1-gpt-codex.md`; critic v7.3.0; audit96; agency blueprint14; current RepoConnect/sync-wiki/wiki-retrieve/Studio/analytics; Jasper/HubSpot/Buffer/Sprout; RFC9700.
