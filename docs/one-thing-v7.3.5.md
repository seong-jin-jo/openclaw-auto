# OSMU Marketing Agent — One Thing v7.3.5
...
evidence: PRD v7.3.5, critic v7.3.4, updated audit96 v1.2/P0-8, independent H/E/F288 manifest, Jasper/HubSpot official workflows
...
SOURCES: `openclaw-auto-marketing-agent-prd-v7.3.5-gpt-codex.md`; `tasks/marketing-agent-plan-critic-v7.3.4.output`; updated final audit96 v1.2; independent ABC/DE/FGH H/E/F288 manifest; agency blueprint14; Notion export; Medium/Substack publishing help; Jasper Brand Voice/Knowledge Base; HubSpot Campaigns.
MODEL: gpt-codex/gpt-5.6-sol
